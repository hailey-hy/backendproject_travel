...
<script src="btnFunction.js"></script>
<script>
$(document).ready(function() {
			...
			$('form').on('submit', function() {
				...
				let activities_ggdo = [ 
					{ name: "강원 제이 글램핑", price: 100000 }, 
					{ name: "강원 그레이스 펜션", price: 200000 },
					{ name: "강원 럭셔리 호텔", price: 150000 }
				];
 ...
 <a class="navbar-brand" href="#">&nbsp;&nbsp;<img src="./img/logo.png" width="50px" height="50px">&nbsp;&nbsp;전국이내손안에</a>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
	...
	<input id="ggdo" class="tab-item" type="button" value="경기도" onCLick="location.href='gyeonggido.html'" >&nbsp;
		<input id="gwdo" class="tab-item tab-background" type="button" value="강원도" onCLick="location.href='gangwondo.html'">&nbsp;
    ...
    <table class="tbl">
        <tr>
            <td><img class="mainImg" src="./img/gang1.jpg"></td>
            <td id="gw" class="explanation">
        <b>제이 글램핑</b><br><br>
                주소:강원 강릉시 해안로 63 <br><br>
                가격: 60,000원/박 <br><br>
                편의시설: 주차장, 수영장, 편의점<br><br>
            </td>
            <td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
            <td><input type="radio" name="select" value="강원 제이 글램핑"/></td>
        </tr>
        <tr>
            <td><img class="mainImg" src="./img/gang2.jpg"></td>
            <td id="gw" class="explanation">
        <b>그레이스 펜션</b><br><br>    
                주소: 강원 양양군 손양면 선사유적로 31<br><br>
                가격: 150,000원/박<br><br>
                편의시설: 주차장, 수영장, 바비큐장<br><br>
            </td>
            <td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
            <td><input type="radio" name="select"/ value="강원 그레이스 펜션"></td>
        </tr>
        <tr>
            <td><img class="mainImg" src="./img/gang3.jpg"></td>
            <td id="gw" class="explanation">
        <b>럭셔리 호텔</b><br><br>
                주소: 강원 홍천군 내촌면 아홉사리로 162 <br><br>
                가격: 100,000원/박 <br><br>
                편의시설: 주차장, 편의점, 실내 수영장<br><br>
             </td>
            <td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
            <td><input type="radio" name="select" value="걍원 럭셔리 호텔"/></td>
