...
$(document).ready(function() {
			...
			$('form').on('submit', function() {
				...
				let activities_ggdo = [ 
					{ name: "경기 해오름 글램핑", price: 100000 }, 
					{ name: "경기 슬기로운 펜션", price: 200000 },
					{ name: "경기 힐링 호텔", price: 150000 }
				];
 ...
 <a class="navbar-brand" href="#">&nbsp;&nbsp;<img src="./img/logo.png" width="50px" height="50px">&nbsp;&nbsp;전국이내손안에</a>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
	...
	<form class="reserveInput" action="Purchase.html">
		<table class="tbl">
        <tr>
            <td><img class="mainImg" src="./img/gyeong1.jpg"></td>
            <td id="gg" class="explanation">
      	<b>해오름 글램핑</b><br><br>
                주소: 경기 여주시 산북면 해오름로 66<br><br>
                가격: 100,000원/박 <br><br>
                편의시설: 주차장, 수영장, 편의점<br><br>
            </td>
            <td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
            <td><input type="radio" name="select" value="경기 해오름 글램핑" /></td>
        </tr>
        <tr>
            <td><img class="mainImg" src="./img/gyeong2.jpg"></td>
            <td id="gg" class="explanation">
        <b>슬기로운 펜션</b><br><br>        
                주소: 경기도 가평군 가평읍 북한강변로 1<br><br>
                가격: 200,000원/박 <br><br>
                편의시설: 주차장, 수영장, 바비큐장<br><br>
            </td>
            <td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
            <td><input type="radio" name="select" value="경기 슬기로운 펜션"/></td>
        </tr>
        <tr>
            <td><img class="mainImg" src="./img/gyeong3.jpg"></td>
            <td id="gg" class="explanation">
        <b>힐링 호텔</b><br><br>           
                주소: 경기도 가평군 청평면 북한강로 22 <br><br>
                가격: 150,000원/박<br><br>
                편의시설: 주차장, 편의점, 실내 수영장<br><br>
            </td>
            <td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
            <td><input type="radio" name="select" value="경기 힐링 호텔"/></td>
