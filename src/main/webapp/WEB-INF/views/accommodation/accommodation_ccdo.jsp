...
$(document).ready(function() {
			...
			$('form').on('submit', function() {
				...
				let activities_ggdo = [ 
					{ name: "충청 스타 글램핑", price: 80000 }, 
					{ name: "충청 어반슬로우  펜션", price: 110000 },
					{ name: "충청 스테이 호텔", price: 100000 }
				];
...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
	...
	<div id="selectParent">&nbsp; 
		...
		<input id="ccdo" class="tab-item tab-background" type="button" value="충청도" onCLick="location.href='chungcheongdo.html'">&nbsp;
	...
	<form class="reserveInput" action="Purchase.html">
     <table class="tbl">
        <tr>
            <td><img class="mainImg" src="./img/chung1.jpg"></td>
            <td id="gg" class="explanation">
        <b>스타 글램핑</b><br><br>
                주소:충북 단양군 영춘면 남천2길 2 <br><br>
                가격: 80,000원/박 <br><br>
                편의시설: 주차장, 수영장, 편의점<br><br>
            </td>
            <td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
            <td><input type="radio" name="select" value="충청 스타 글램핑"/></td>
        </tr>
        <tr>
            <td><img class="mainImg" src="./img/chung2.jpg"></td>
            <td id="gg" class="explanation">
        <b>어반슬로우 펜션</b><br><br>
                주소: 충북 단양군 가곡면 한드미길 28 <br><br>
                가격: 110,000원/박 <br><br>
                편의시설: 주차장, 수영장, 바비큐장<br><br>
            </td>
            <td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
            <td><input type="radio" name="select" value="충청 어반슬로우 펜션"/></td>
        </tr>
        <tr>
            <td><img class="mainImg" src="./img/chung3.jpg"></td>
            <td id="gg" class="explanation">
        <b>스테이 호텔</b><br><br>
                주소: 충북 청주시 상당구 미원면 미원초정로 9 <br><br>
                가격: 100,000원/박 <br><br>
                편의시설: 주차장, 편의점, 실내 수영장<br><br>
             </td>
            <td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
            <td><input type="radio" name="select" value="충청 스테이 호텔"/></td>
