...
$(document).ready(function() {
			...
			$('form').on('submit', function() {
				...
				let activities_ggdo = [ 
					{ name: "제주 달빛마루 글램핑", price: 150000 }, 
					{ name: "제주 헬로우 펜션", price: 70000 },
					{ name: "제주 코리아 호텔", price: 200000 }
				];
...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
	...
	<div id="selectParent">&nbsp; 
		...
		<input id="jjdo" class="tab-item tab-background" type="button" value="제주도" onCLick="location.href='jejudo.html'">&nbsp;
	</div>
	<form class="reserveInput" action="Purchase.html">
      <table class="tbl">
        <tr>
            <td><img class="mainImg" src="./img/jeju1.jpg"></td>
            <td id="gg" class="explanation">
        <b>달빛마루 글램핑</b><br><br>
                주소: 제주 제주시 한경면 일주서로 4 <br><br>
                가격: 150,000원/박 <br><br>
                편의시설: 주차장, 수영장, 편의점<br><br>
            </td>
            <td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
            <td><input type="radio" name="select" value="제주 달빛마루 글램핑"/></td>
        </tr>
        <tr>
            <td><img class="mainImg" src="./img/jeju2.jpg"></td>
            <td id="gg" class="explanation">
        <b>헬로우 펜션</b><br><br>
                주소: 제주 제주시 애월읍 도치돌길 2 <br><br>
                가격: 70,000원/박 <br><br>
                편의시설: 주차장, 수영장, 바비큐장<br><br>
            </td>
            <td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
            <td><input type="radio" name="select" value="제주 헬로우 펜션"/></td>
        </tr>
        <tr>
            <td><img class="mainImg" src="./img/jeju3.jpg"></td>
            <td id="gg" class="explanation">
        <b>코리아 호텔</b><br><br>
                주소: 제주 제주시 조천읍 남조로 1717-24 <br><br>
                가격: 200,000원/박 <br><br>
                편의시설: 주차장, 편의점, 실내 수영장<br><br>
            </td>
            <td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
            <td><input type="radio" name="select" value="제주 코리아 호텔"/></td>
