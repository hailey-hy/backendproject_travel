...
$(document).ready(function() {
			...
			$('form').on('submit', function() {
				...
				let activities_ggdo = [ 
					{ name: "경상 자연휴 글램핑", price: 100000 }, 
					{ name: "경상 솔방울  펜션", price: 250000 },
					{ name: "경상 네이처 호텔", price: 170000 }
				];
...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
	...
	<div id="selectParent">&nbsp; 
		...
		<input id="gsdo" class="tab-item tab-background" type="button" value="경상도" onCLick="location.href='gyeongsangdo.html'">&nbsp;
	...
	<form class="reserveInput" action="Purchase.html">
     <table class="tbl">
        <tr>
            <td><img class="mainImg" src="./img/gyeongs1.jpg"></td>
            <td id="gg" class="explanation">
        <b>자연휴 글램핑</b><br><br>
                주소: 경북 영덕군 축산면 축산항2길 <br><br>
                가격: 100,000원/박 <br><br>
                편의시설: 주차장, 수영장, 편의점<br><br>
            </td>
            <td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
            <td><input type="radio" name="select" value="경상 자연휴 글램핑"/></td>
        </tr>
        <tr>
            <td><img class="mainImg" src="./img/gyeongs2.jpg"></td>
            <td id="gg" class="explanation">
        <b>솔방울 펜션</b><br><br>
                주소: 경북 경주시 감포읍 감포로 22 <br><br>
                가격: 250,000원/박 <br><br>
                편의시설: 주차장, 수영장, 바비큐장<br><br>
            </td>
            <td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
            <td><input type="radio" name="select" value="경상 솔방울 펜션"/></td>
        </tr>
        <tr>
            <td><img class="mainImg" src="./img/gyeongs3.jpg"></td>
            <td id="gg" class="explanation">
        <b>네이처 호텔</b><br><br>
                주소: 경북 경주시 천북면 새터흥림길 1 <br><br>
                가격: 170,000원/박 <br><br>
                편의시설: 주차장, 편의점, 실내 수영장<br><br>
            </td>
            <td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
            <td><input type="radio" name="select" value="경상 네이처 호텔"/></td>
